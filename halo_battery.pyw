...
from providers import (AudezeProvider, BluetoothProvider, DeviceStatus, CorsairProvider, HyperXProvider,  # noqa: E402
...
class App:
    def __init__(self):
        ...
        self.providers = [RazerProvider(), AudezeProvider(), WLmouseProvider(), MchoseProvider(),
                          HyperXProvider(), CorsairProvider(), LogitechProvider(), SteelSeriesProvider(), XInputProvider(),
                          PlayStationProvider()]
