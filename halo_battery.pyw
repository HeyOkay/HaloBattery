...
from providers import (AudezeProvider, BluetoothProvider, DeviceStatus, PulsarProvider, HyperXProvider,  # noqa: E402
...
class App:
    def __init__(self):
        ...
        self.providers = [RazerProvider(), AudezeProvider(), WLmouseProvider(), MchoseProvider(),
                          HyperXProvider(), PulsarProvider(), LogitechProvider(), SteelSeriesProvider(), XInputProvider(),
                          PlayStationProvider()]
