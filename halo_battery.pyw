...
from providers import (AudezeProvider, BluetoothProvider, DeviceStatus, KeychronProvider, HyperXProvider,  # noqa: E402
...
class App:
    def __init__(self):
        ...
        self.providers = [RazerProvider(), AudezeProvider(), WLmouseProvider(), MchoseProvider(),
                          HyperXProvider(), KeychronProvider(), LogitechProvider(), SteelSeriesProvider(), XInputProvider(),
                          PlayStationProvider()]
