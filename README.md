...
| Logitech G502 LIGHTSPEED | Lightspeed receiver (046D:C539, 046D:C547) | HID++ 2.0 on the receiver's vendor interface: the device name (feature 0x0005) and the first battery feature the device supports (0x1004 unified battery, 0x1000 battery status or 0x1001 battery voltage; the G502 reports voltage, converted to % with the Li-ion curve used by Solaar). Works alongside G HUB |
